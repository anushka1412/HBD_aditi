...
const second = 1000,
  ...
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date('Jully 18, 2021 00:00:00').getTime(),
...
new TypeIt("#teks1", {
  strings: ["Hey brooo!!", " ", "Before I met you I never knew what it was like to just look at someone and laugh for no reason😂.", " ", "<b>I can't believe we've known each other for 5 years and counting!</b>", " ", "We have been stupid together,weird together, crazy together😜.", "When I'm sad you are always there for me no matter what!", , " ", "I am more than blessed to have you in my life, even though we've had arguments in the past we're always looking towards the future!", " ","I wish nothing but the best for you bestie😘."],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [" Thank you so much love for always being there for me whenever i needed someone the most. Will be there by your side always no matter what!❤", ],
  startDelay: 2000,
  speed: 75,
  loop: false,
  waitUntilVisible: true,
